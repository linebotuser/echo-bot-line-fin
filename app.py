...
#-------------------------------------------------------------------------------------------------------------------------FOR TEST USE
            ...
            url = request.url_root + './static/22.jpg'
            ...
            line_bot_api.reply_message(
                ReplyMessageRequest(
                    ...
                    messages=[
                        ...
                        TextMessage(text="關於大溪觀光季節/n可以點擊下列連結獲取更多資訊(Happy)https://www.tycg.gov.tw/ActiveMonthList.aspx?n=8&sms=7883#")
                    ]
                )
            )
        
        elif text == 'DaxiTourismSeason':
            url = request.url_root + './static/11.jpg'
            url = url.replace("http", "https")
            app.logger.info("url=" + url)
            line_bot_api.reply_message(
                ReplyMessageRequest(
                    ...
                    messages=[
                        ImageMessage(original_content_url=url, preview_image_url=url),
                        TextMessage(text="About the Daxi sightseeing season More information can be found at the following links.(Happy)https://www.tycg.gov.tw/ActiveMonthList.aspx?n=8&sms=7883#")
                    ]
                )
            )
            
        elif text == '大渓観光シーズン':
            url = request.url_root + './static/33.jpg'
            url = url.replace("http", "https")
            app.logger.info("url=" + url)
            line_bot_api.reply_message(
                ReplyMessageRequest(
                    ...
                    messages=[
                        ImageMessage(original_content_url=url, preview_image_url=url),
                        TextMessage(text="大渓観光シーズンについて 詳細については、次のリンクを参照してください(Happy)https://www.tycg.gov.tw/ActiveMonthList.aspx?n=8&sms=7883#")
                    ]
                )
            )
